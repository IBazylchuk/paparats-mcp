...
const CODE_MODEL_NAME = 'bge-code-v1';
const CODE_GGUF_URL =
 ...
 *  Both models are qwen-decoder based \u2192 --pooling last (bge-code-v1 = qwen2,
 *  Qwen3-Embedding = qwen3). Wrong pooling silently corrupts the vector space. */
